...
% Title.
% ------
\title{V20151231: NEAR EARTH BODY DETECTION and linking}
%
% Single address.
% ---------------
...
\tikzstyle{block} = [rectangle, minimum width=2cm, minimum height=1cm, text centered, text width=1cm, draw=black, fill=blue!15]
