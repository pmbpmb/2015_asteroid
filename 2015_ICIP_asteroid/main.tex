...
\State Find the connected components in the difference images, Subsequently filter out hollow objects to produce a set of candidate moving objects on each image.
