...
\State Find the connected components in the difference images, filter out hollow objects based on connected component area and size to produce a set of candidate moving objects on each image.
