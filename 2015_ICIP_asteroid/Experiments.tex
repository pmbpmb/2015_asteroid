...
\end{center}
\vspace{-0.7cm}
\caption{Image Processing results shown on CSS data.The registered images are super-imposed to visualize the trajectory in a single image.Asteroid trajectory detected is shown in green, true location of the asteroid is in red. Left: Trajectories detected on a triplet. Right: Trajectory detected on a quadruplet.}
