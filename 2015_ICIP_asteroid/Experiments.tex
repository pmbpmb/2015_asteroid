...
\begin{center}$
\begin{array}{ccc}
\includegraphics[width=0.13\textwidth]{Figures/NEAT1.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEAT2.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEAT3.pdf} \\
\includegraphics[width=0.13\textwidth]{Figures/NEATImageReg12.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEATImageReg32.pdf} \\
\includegraphics[width=0.13\textwidth]{Figures/NEATImageDiff1.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEATImageDiff2.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEATImageDiff3.pdf} \\
\includegraphics[width=0.13\textwidth]{Figures/NEATFilteredCentroids1.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEATFilteredCentroids2.pdf} &
\includegraphics[width=0.13\textwidth]{Figures/NEATFilteredCentroids3.pdf}
\end{array}$
\end{center}
...
\begin{center}$
\begin{array}{cccc}
\includegraphics[width=0.23\textwidth]{Figures/NEAT1.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATImageReg12.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATImageDiff1.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATFilteredCentroids1.pdf} \\
\includegraphics[width=0.23\textwidth]{Figures/NEAT2.pdf} &
 &
\includegraphics[width=0.23\textwidth]{Figures/NEATImageDiff2.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATFilteredCentroids2.pdf} \\
\includegraphics[width=0.23\textwidth]{Figures/NEAT3.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATImageReg32.pdf} &
\includegraphics[width=0.23\textwidth]{Figures/NEATImageDiff3.pdf} 
\includegraphics[width=0.23\textwidth]{Figures/NEATFilteredCentroids3.pdf} 
\end{array}$
\end{center}
\caption{Image Processing Pipeline results. 
First column: 2002 CY46 Triplet images taken 10 minutes apart. Near Earth Asteroid Tracking (NEAT) system archive. 
Second Column: Image Registration results for the CY46 Triplet.  Top: Image-1 registered to Image-2. Bottom: Image-3 registered to Image-2.
Third Column: Image Differencing results for the CY46 Triplet. (Artifacts such as crater-like formations are seen in the difference images above. This is the result of some celestial bodies being over-exposed.) 
Fourth Column: Image Differencing results for the CY46 Triplet. Filtered centroids in each image of the sequence.)}
